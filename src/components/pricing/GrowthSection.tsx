  ...
  return (
    <div className="panel-premium flex flex-col p-7">
      ...
      <div className="mt-5 flex items-center gap-3">
        <div className="relative flex flex-1 items-center justify-between gap-3 rounded-xl bg-bg-deep/60 px-4 py-3 [box-shadow:inset_0_0_0_1px_oklch(0.82_0.135_84_/_0.35)]">
          {/* perforated notches */}
          <span
            aria-hidden
