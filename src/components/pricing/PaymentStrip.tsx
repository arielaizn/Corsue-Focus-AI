...
export function PaymentStrip({ t }: Props) {
  return (
    <div className="panel-premium px-8 py-9">
      ...
      <div className="mt-6 flex flex-wrap items-center justify-center gap-3">
        {t.providers.map((p) => (
          <div
            key={p.name}
            dir="ltr"
            className="flex items-center gap-2 rounded-xl bg-bg-deep/50 px-4 py-2.5 ring-line transition-colors hover:bg-surface-2"
          >
