...
export function CurriculumPath({
  ...
  return (
    <div className="rounded-2xl bg-surface/30 p-5 [box-shadow:inset_0_0_0_1px_var(--color-line)] sm:p-7">
            ...
            <li key={lvl.name} className="relative flex gap-4 ps-2">
              ...
              <div className="relative flex flex-col items-center">
                <span
                  ...
                  style={{
                    backgroundColor: `oklch(0.62 0.2 264 / ${fill})`,
                    boxShadow: `inset 0 0 0 1px oklch(0.62 0.2 264 / ${fill + 0.3})`,
                  }}
                >
                  {i + 1}
                </span>
                {!last && (
                  <span
                    aria-hidden
                    className="my-1 w-px flex-1 bg-gradient-to-b from-[oklch(0.62_0.2_264_/_0.6)] to-[oklch(0.6_0.25_300_/_0.3)]"
                  />
                )}
              </div>
              ...
              <div className={last ? "pb-0" : "pb-6"}>
                <div className="flex flex-wrap items-baseline gap-x-2.5 gap-y-1">
                  ...
                  <span className="rounded-full bg-bg-deep/60 px-2 py-0.5 text-[11px] font-medium text-gold [box-shadow:inset_0_0_0_1px_oklch(0.82_0.135_84_/_0.3)]">
                    {lvl.tag}
                  </span>
                </div>
