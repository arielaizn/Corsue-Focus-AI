/* Shared input/control classes for the GRADING feature, matching the auth /
   courses form convention (Midnight Atelier / Obsidian Couture). */
...
export const ghostBtn =
  "inline-flex items-center justify-center gap-2 rounded-xl px-4 py-2.5 text-sm font-semibold text-ink-soft transition-colors hover:text-ink [box-shadow:inset_0_0_0_1px_var(--color-line)] disabled:opacity-50";

export const dangerText = "text-[oklch(0.78_0.16_22)]";

export const noticeText = "text-gold";
